...
export default function AdminProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 p-4 sm:p-6 lg:p-8 space-y-6">
      {/* Breadcrumb */}
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400">{total} total products</p>
          </div>
        </div>

        <div className="flex items-center gap-3">
          <Link href="/admin/products/recommended">
            <Button
              variant="outline"
              className="gap-2 bg-transparent border-amber-500/30 text-amber-400 hover:bg-amber-500/10"
            >
          ...
          <Link href="/admin/products/new">
            <Button className="gap-2 bg-amber-500 hover:bg-amber-400 text-black">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            {!search && !typeFilter && !statusFilter && (
              <Link href="/admin/products/new">
                <Button className="gap-2 bg-amber-500 hover:bg-amber-400 text-black cursor-pointer">
                  <Plus className="w-4 h-4" />
                  Add Product
                </Button>
              </Link>
