...
export default function DashboardPage() {
  ...
  return (
    <div className="bg-transparent space-y-6">
      ...
      {/* Profile Banner - Updated to double-box design */}
      {profile && (
      ...
      {/* Quick Stats - Updated to double-box design */}
      <div className="rounded-2xl border border-white/[0.08] p-3">
        <div className="bg-[#0f0f0f] rounded-xl p-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-[#1a1a1a] border border-white/[0.05] rounded-xl p-4 sm:p-5">
      ...
      {/* Action Cards Grid - Updated to double-box design */}
      <div className="rounded-2xl border border-white/[0.08] p-3">
        <div className="bg-[#0f0f0f] rounded-xl p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {actionCards.map((card) => (
              <Link key={card.title} href={card.href} className="group cursor-pointer">
                <div className="bg-[#1a1a1a] border border-white/[0.05] hover:border-amber-500/30 rounded-xl p-4 sm:p-5 transition-all h-full cursor-pointer">
