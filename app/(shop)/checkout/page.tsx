    ...
    return (
      <div className="min-h-screen bg-transparent flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-zinc-400 mb-6 text-sm sm:text-base">Add some items to your cart to checkout</p>
          <Button
            onClick={() => router.push("/")}
    ...
    <div className="min-h-screen bg-transparent">
      <main className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="flex items-center justify-center gap-1 sm:gap-2 mb-6 sm:mb-10">
          {[
            ...
            <div key={s.num} className="flex items-center gap-1 sm:gap-2">
              ...
              <span
                className={`hidden sm:block text-xs sm:text-sm font-medium ${step >= s.num ? "text-white" : "text-zinc-500"}`}
              >
                {s.label}
              </span>
              {i < 2 && <div className={`w-6 sm:w-8 md:w-16 h-0.5 ${step > s.num ? "bg-amber-500" : "bg-zinc-700"}`} />}
            </div>
          ))}
        </div>
        ...
        {step === 4 ? (
          ...
          <div className="max-w-2xl mx-auto px-1">
            ...
            <div className="text-center mb-6 sm:mb-8">
              <div className="relative inline-flex items-center justify-center mb-4 sm:mb-6">
                <div className="absolute w-16 h-16 sm:w-24 sm:h-24 bg-emerald-500/20 rounded-full animate-ping" />
                <div className="relative w-14 h-14 sm:w-20 sm:h-20 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/30">
                  <CheckCircle2 className="w-7 h-7 sm:w-10 sm:h-10 text-white" />
                </div>
              </div>
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">Order Placed Successfully</h1>
            ...
            <div className="flex flex-col gap-3">
              <Button
                ...
                variant="outline"
                className="w-full border-zinc-700 text-white hover:bg-zinc-800 font-medium h-11 sm:h-12 cursor-pointer text-sm sm:text-base"
              >
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black font-semibold h-11 sm:h-12 cursor-pointer text-sm sm:text-base"
              >
                Continue Shopping
            ...
            {/* Support Note */}
            <p className="text-center text-zinc-500 text-xs mt-4 sm:mt-6 px-2">
          ...
          /* Made grid responsive - show summary at bottom on mobile */
