...
import { ChevronRight, Home, Grid, Star, Eye } from "lucide-react"
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-zinc-800">
                  ...
                  <div className="absolute top-2 left-2 flex flex-col gap-1">
                    {product.discount_percent && product.discount_percent > 0 && (
                      <span className="bg-gradient-to-r from-amber-600 to-orange-500 text-white text-[10px] sm:text-xs px-1.5 py-0.5 rounded font-bold">
                        -{product.discount_percent}%
                      </span>
                    )}
                    {product.is_new && (
                      <span className="bg-green-600 text-white text-[10px] sm:text-xs px-1.5 py-0.5 rounded font-medium">
                        NEW
                      </span>
                    )}
                    {product.is_bestseller && (
                      <span className="bg-amber-600 text-white text-[10px] sm:text-xs px-1.5 py-0.5 rounded font-medium">
                        BEST
                      </span>
                    )}
                  </div>
                  ...
                  {product.tags && product.tags.length > 0 && (
                    <div className="flex flex-wrap gap-1 mt-2">
                      {product.tags.slice(0, 2).map((tag, i) => (
                        <span key={i} className="text-[10px] text-zinc-500 bg-zinc-800 px-1.5 py-0.5 rounded">
                          {tag}
                        </span>
                      ))}
                    </div>
