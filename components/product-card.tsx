...
const ProductCard = memo(
  function ProductCard({ product, index = 0, showTags = true }: ProductCardProps) {
      ...
      <li>
        ...
        >
          ...
          <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-800">
            ...
            />
            {/* ... existing overlay and labels code ... */}
            ...
            {showTags && product.tags && product.tags.length > 0 && (
              <div className="flex flex-wrap gap-1 mb-2">
                ...
                {product.tags.length > 2 && (
                  <span className="text-[9px] text-zinc-500">+{product.tags.length - 2}</span>
                )}
              </div>
            )}
