...
export default function ProductTagsSEO() {
  ...
  if (loading) {
    return (
      <section className="px-4 sm:px-6 lg:px-8 py-12 md:py-16 bg-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <div className="h-10 w-10 bg-[#1E1E1E]/30 rounded-xl animate-pulse" />
            <div className="space-y-2">
              <div className="h-6 w-48 bg-[#1E1E1E]/30 rounded-lg animate-pulse" />
              <div className="h-4 w-32 bg-[#1E1E1E]/30 rounded animate-pulse" />
            </div>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="bg-[#1E1E1E]/30 backdrop-blur-sm rounded-xl border border-zinc-800/20 p-4 space-y-3"
              >
                <div className="flex items-center gap-2">
                  <div className="h-5 w-5 bg-[#1E1E1E]/50 rounded animate-pulse" />
                  <div className="h-5 w-24 bg-[#1E1E1E]/50 rounded animate-pulse" />
                </div>
                <div className="flex flex-wrap gap-2">
                  {[...Array(6)].map((_, j) => (
                    <div
                      key={j}
                      className="h-8 bg-[#1E1E1E]/50 rounded-full animate-pulse"
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative overflow-hidden bg-transparent">
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          {groupedProducts.map((group) => {
            ...
            return (
              <motion.article
                key={group.type}
                className="bg-[#1E1E1E]/30 backdrop-blur-sm rounded-xl border border-zinc-800/20 overflow-hidden hover:border-amber-500/20 transition-colors group"
                variants={itemVariants}
                whileHover={{ y: -2, transition: { duration: 0.2 } }}
              >
                <header className="px-4 py-3 border-b border-zinc-800/30">
        ...
        >
          <div className="p-5 rounded-xl bg-[#1E1E1E]/30 backdrop-blur-sm border border-zinc-800/20">
