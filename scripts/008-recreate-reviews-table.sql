-- Drop existing reviews table if it has wrong schema
...
-- Insert initial real reviews (without product_id first, then we'll link them)
-- These will be general reviews that apply to any product
